...
def print_pause(list_of_text_to_print, pause_duration=2):
...
def level_resolver(floor_index, initial_state, current_state, floors_dict):
    ...
    # Upon re-entering when a level. This HAS to True True.
    # False False is not possible since level_resolver would not be called if
    ...
    if not initial_state[floor_index] and current_state[floor_index]:
        ...
        if previous_levels_visited:
            ...
            print_pause(level_data["fail_text"][index])
    ...
    for level, level_data in floors_dict.items():
        if level == choice_floor:
            ...
            user_journey_text = [
                ...
                f"After a few moments, you find yourself "
                f"in the {level_data['name_l']}.",
            ]
            print_pause(user_journey_text)
            new_visited_list = level_resolver(
                index,
                floors_visited_states_list,
                new_visited_list,
                floors_dict,
            )
        index += 1
    ...
    floors = {
        ...
        "2": {
            ...
            "fail_text": [
                [
                    "The head of HR greets you.",
                    "He has something for you, but says he can't give it "
                    "to you until you go get your ID card.",
                    "You head back to the elevator.",
                ]
            ],
        },
        "3": {
            ...
            "success_text": [
                ...
                "Your program manager greets you and tells you that you need "
                "to have a copy of the employee handbook "
                "in order to start work.",
                "Fortunately, you got that from HR!",
                "Congratulatons! You are ready to start your new job "
            ...
            "fail_text": [
                [
                    ...
                    "It looks like you need some kind of "
